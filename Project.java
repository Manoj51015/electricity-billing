...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/elect1.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon2.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon3.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon4.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon5.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon6.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon7.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon12.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon9.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon10.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("electricity/Icons/icon11.png"));
